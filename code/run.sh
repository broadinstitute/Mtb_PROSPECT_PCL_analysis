...
#matlab -nodisplay -r "addpath(genpath('.')); run_pcl_confidence_scoring; quit"
...
# Path to final RMarkdown file from uploaded, original cluster results produced using Matlab 2020a
...
# Path to final RMarkdown file from newly processed cluster results produced using Matlab 2020b
