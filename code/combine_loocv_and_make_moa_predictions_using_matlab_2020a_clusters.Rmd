---
title: "Combine LOOCV results and make KABX and test compound PCL-based MOA predictions using cluster results from software version Matlab 2020a"
date: "`r Sys.Date()`"
...
out_tbl_savename = 'by_pcl_similarity_to_confidence_score_thresholds_from_training_on_kabx.txt.gz' # compressed in Matlab on previous step for storage-efficiency purposes

opt_tbl_savename = 'by_pcl_high_confidence_similarity_score_thresholds_from_training_on_kabx.txt.gz' # compressed in Matlab on previous step for storage-efficiency purposes
